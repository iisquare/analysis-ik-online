package com.iisquare.solr.wltea.util;
...
public class ValidateUtil {
	...
	public static boolean isNull(String object, boolean bTrim) {
		return null == object
				|| "".endsWith(bTrim ? DPUtil.trim(object) : object);
	}
	...
	public static Integer filterInteger(Object object, boolean bBound,
			Integer min, Integer max, Integer defaultValue) {
		int obj = DPUtil.parseInt(object);
		if (null != min && obj < min)
			return bBound ? min : defaultValue;
		if (null != max && obj > max)
			return bBound ? max : defaultValue;
		return obj;
	}

	public static Long filterLong(String object, boolean bBound, Long min,
	...
	public static Double filterDouble(String object, boolean bBound,
			Double min, Double max, Integer defaultValue) {
	...
	public static Float filterFloat(String object, boolean bBound, Float min,
			Float max, Integer defaultValue) {
	...
	public static String filterRegex(String pattener, String object,
			boolean bTrim, Integer min, Integer max, String defaultValue) {
		if (null == object)
			return defaultValue;
		if (bTrim)
			object = DPUtil.trim(object);
		if (min > 0 && !DPUtil.isMatcher(pattener, object))
			return defaultValue;
		return filterLength(object, min, max, defaultValue);
	}

	public static String filterEnglish(String object, boolean bTrim,
			Integer min, Integer max, String defaultValue) {
		return filterRegex(regexEnglish, object, bTrim, min, max, defaultValue);
	}

	public static String filterChinese(String object, boolean bTrim,
			Integer min, Integer max, String defaultValue) {
		return filterRegex(regexChinese, object, bTrim, min, max, defaultValue);
	}

	public static String filterWord(String object, boolean bTrim, Integer min,
			Integer max, String defaultValue) {
		return filterRegex(regexWord, object, bTrim, min, max, defaultValue);
	}

	public static String filterSimpleString(String object, boolean bTrim,
			Integer min, Integer max, String defaultValue) {
		return filterRegex(regexSimpleString, object, bTrim, min, max,
				defaultValue);
	}

	public static String filterEmail(String object, boolean bTrim, Integer min,
			Integer max, String defaultValue) {
		return filterRegex(regexEmail, object, bTrim, min, max, defaultValue);
	}

	public static String filterDomain(String object, boolean bTrim,
			Integer min, Integer max, String defaultValue) {
		return filterRegex(regexDomain, object, bTrim, min, max, defaultValue);
	}

	public static String filterUrl(String object, boolean bTrim, Integer min,
			Integer max, String defaultValue) {
		return filterRegex(regexUrl, object, bTrim, min, max, defaultValue);
	}

	public static String filterIPv4(String object, boolean bTrim, Integer min,
			Integer max, String defaultValue) {
		return filterRegex(regexIPv4, object, bTrim, min, max, defaultValue);
	}

	public static String filterMobile(String object, boolean bTrim,
			Integer min, Integer max, String defaultValue) {
		return filterRegex(regexMobile, object, bTrim, min, max, defaultValue);
	}

	public static String filterPhone(String object, boolean bTrim, Integer min,
			Integer max, String defaultValue) {
		return filterRegex(regexPhone, object, bTrim, min, max, defaultValue);
	}

	public static String filterIdCard(String object, boolean bTrim,
			Integer min, Integer max, String defaultValue) {
		return filterRegex(regexIdCard, object, bTrim, min, max, defaultValue);
	}

	public static String filterPostCode(String object, boolean bTrim,
			Integer min, Integer max, String defaultValue) {
		return filterRegex(regexPostCode, object, bTrim, min, max, defaultValue);
	}

	public static String filterDateTime(String object, boolean bTrim,
	 ...
	 */
	public static String filterItem(String object, boolean bTrim,
			String[] itemArray, String defaultItem) {
		if (null == object)
			return defaultItem;
		if (bTrim)
			object = DPUtil.trim(object);
		for (String item : itemArray) {
			if (DPUtil.equals(object, item))
				return item;
		}
		return defaultItem;
	}
