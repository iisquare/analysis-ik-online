...
public final class IKSegmenter {
	...
	private void init() {
		// 初始化分词上下文
		this.context = new AnalyzeContext(this.dictSerial, this.useSmart,
				this.useArabic, this.useEnglish);
		// 加载子分词器
	...
	private List<ISegmenter> loadSegmenters() {
		...
		// 处理中文数量词的子分词器
		segmenters.add(new CN_QuantifierSegmenter(this.dictSerial));
		// 处理中文词的子分词器
		segmenters.add(new CJKSegmenter(this.dictSerial));
		return segmenters;
	}
